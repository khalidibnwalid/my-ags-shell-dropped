    ...
    export namespace Cogl {
        ...
        class AttributeBuffer extends Object {
            ...
            emit<K extends keyof AttributeBuffer.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<AttributeBuffer.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class OnscreenTemplate extends Object {
            ...
            emit<K extends keyof OnscreenTemplate.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<OnscreenTemplate.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class Texture2DSliced extends Object implements Texture {
            ...
            emit<K extends keyof Texture2DSliced.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<Texture2DSliced.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class TexturePixmapX11 extends Object {
            ...
            emit<K extends keyof TexturePixmapX11.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<TexturePixmapX11.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
        ...
        class TextureRectangle extends Object implements Texture {
            ...
            emit<K extends keyof TextureRectangle.SignalSignatures>(
                signal: K,
                ...args: GObject.GjsParameters<TextureRectangle.SignalSignatures[K]> extends [any, ...infer Q]
                    ? Q
                    : never
            ): void;
            emit(signal: string, ...args: any[]): void;
